...
New-Item -ItemType Directory -Force -Path $ModsRoot, $ClassesRoot | Out-Null
...
& java "-javaagent:$ResolvedAgent=root=$RootEncoded;session=$SessionEncoded" -cp $FixtureJar AgentFixture $InstanceRoot
